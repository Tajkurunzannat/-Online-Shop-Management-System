...
<?php
   $womens_product_details="";
   $womens_product_prices="";
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$womens_product_details= $_POST['womens_product_details'];
	$womens_product_prices = $_POST['womens_product_prices'];

    move_uploaded_file($file_temp, $uploaded_image);
    $query = "INSERT INTO womens_product_inventory(womens_product_image, womens_product_details, womens_product_prices) VALUES('$uploaded_image', '$womens_product_details', '$womens_product_prices')";
  ...
  ?>
						...
						<table>
							...
							<tr>
							    <td><textarea id="detail" cols="40" rows="2" name="womens_product_details" placeholder="Write something about the product..."></textarea></td>
								
																		    
								<td><textarea id="price" cols="20" rows="2" name="womens_product_prices" placeholder="Product Price..."></textarea></td>
            ...
            <table >
				...
				<?php
  if (isset($_GET['del'])) {
   $womens_product_id = $_GET['del'];
  
   $getquery = "select * from womens_product_inventory where womens_product_id='$womens_product_id'";
   $getImg = $db->select($getquery);
   if ($getImg) {
    while ($imgdata = $getImg->fetch_assoc()) {
    $delimg = $imgdata['womens_product_image'];
    unlink($delimg);
    }
   }
   
   $query = "delete from womens_product_inventory where womens_product_id='$womens_product_id'";
  ...
  ?>
   ...
   $query = "select * from womens_product_inventory";
   ...
   <tr>
    <td align="center"><?php echo $i; ?></td>
	 <td align="center"><?php echo "<p>".$result['womens_product_details']."</p>"; ?></td>
	 <td align="center"><?php echo "<p>".$result['womens_product_prices']."</p>"; ?></td>
    <td align="center"><img src="<?php echo $result['womens_product_image']; ?>" height="400px" 
      width="300px"/></td>
    <td align="center"><a href="?del=<?php echo $result['womens_product_id']; ?>">Delete</a></td>
   </tr>
  <?php } } ?>
            </table>			
