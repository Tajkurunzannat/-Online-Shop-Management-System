...
<html lang="en" dir="ltr">
  ...
  <body>
	...
	<h2><button type="submit" name="inventory"><a href = "mens_cloth_purchase.php">Go to Mens Product Inventory</a></button></h2>
	<h2><button type="submit" name="inventory"><a href = "womens_cloth_purchase.php">Go to Womens Product Inventory</a></button></h2>
	<h2><button type="submit" name="inventory"><a href = "kids_cloth_purchase.php">Go to Kids Product Inventory</a></button></h2>
