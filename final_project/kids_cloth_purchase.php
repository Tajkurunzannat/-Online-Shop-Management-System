...
function showResult(str) {
  ...
  xmlhttp.send();
   ...
   <tr>
    ...
    <td align="center"><img src="<?php echo $result['kids_product_image']; ?>" height="400px" 
      width="300px"/></td>
    ,<!--<td><a href="?del=<?php echo $result['kids_product_id']; ?>">Buy</a></td>-->
	<td align="center"><input type="checkbox" name="men_buy" value="_POST['kids_product_prices']">Buy</td>
  ...
  <?php } } ?>
			...
			<section class="footeroption" align="right">
			    <button type="submit" name="purchase_btn" value="" ><a href="kids_bill.php" target="_blank">Confirm Purchase</a></button>
