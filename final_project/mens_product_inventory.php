...
<?php
  ...
  ?>
						...
						<table>
							...
							<tr>
							    <td><textarea id="detail" cols="40" rows="2" name="product_details" placeholder="Write something about the product..."></textarea></td>
								
																		    
								<td><textarea id="price" cols="20" rows="2" name="product_prices" placeholder="Product Price..."></textarea></td>
  ...
  ?>
   ...
   <tr>
    ...
    <td align="center"><img src="<?php echo $result['product_image']; ?>" height="400px" 
      width="300px"/></td>
    <td align="center"><a href="?del=<?php echo $result['product_id']; ?>">Delete</a></td>
   </tr>
  <?php } } ?>
            </table>			
